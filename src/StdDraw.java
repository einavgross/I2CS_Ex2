...
/**
 * Ex2: Some changes were added by @einavgross
 */
/**
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static String _lastAction = null;
	...
	public static JMenuBar createMenuBar() {
		...
		JMenuItem menuItem = new JMenuItem("Save Map");
        ...
        menuItem.addActionListener(std);
        menu.add(menuItem);
        menuItem = new JMenuItem("ShortestPath");
        menuItem.addActionListener(std);
        menu.add(menuItem);
        menuBar.add(menu);
        menu = new JMenu("Options");
        menuItem = new JMenuItem("Cyclic");
        menuItem.addActionListener(std);
        menu.add(menuItem);
        menuBar.add(menu);
    ...
    public static String getActionCommand() {
        String res = _lastAction;
        _lastAction = null; // מאפסים כדי שלא נבצע אותה פעולה פעמיים
        return res;
    }
